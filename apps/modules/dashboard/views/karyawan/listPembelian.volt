            ...
            <div class="modal fade" id="add-data">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" action="/karyawan/add-pembelian" method="post" enctype="multipart/form-data" role="form">
                        ...
                        <div class="modal fade" id="edit-data{{beli['id']}}">
                            <div class="modal-dialog modal-lg">
                                ...
                                <span aria-hidden="true">&times;</span>
                                    ...
                                    <form class="form-horizontal" action="/karyawan/edit-pembelian" method="post" enctype="multipart/form-data" role="form">
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <div class="col-lg">
